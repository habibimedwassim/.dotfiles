...
COLOR_SCHEME=$1
COLOR_FILE="$HOME/.dotfiles/i3/colors/${COLOR_SCHEME}.i3colors"
CONFIG_FILE="$HOME/.dotfiles/i3/config"
I3BLOCKS_TEMPLATE="$HOME/.dotfiles/i3blocks/i3blocks.template"
I3BLOCKS_FILE="$HOME/.dotfiles/i3blocks/i3blocks.conf"
ALACRITTY_CONFIG="$HOME/.dotfiles/alacritty/alacritty.toml"
ALACRITTY_THEME_DIR="$HOME/.dotfiles/alacritty/themes/"
